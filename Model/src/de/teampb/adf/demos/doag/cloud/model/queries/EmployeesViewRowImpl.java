...
public class EmployeesViewRowImpl extends ViewRowImpl {
    ...
    public static final int JOBSLOOKUP = AttributesEnum.JobsLookup.index();
    ...
    /**
     * Gets the view accessor <code>RowSet</code> JobsLookup.
     */
    public RowSet getJobsLookup() {
        return (RowSet) getAttributeInternal(JOBSLOOKUP);
    }
}
