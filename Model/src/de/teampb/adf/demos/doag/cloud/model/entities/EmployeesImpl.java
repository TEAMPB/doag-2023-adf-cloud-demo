...
public class EmployeesImpl extends EntityImpl {
     ...
     */
    public boolean validateSalaryInJobRange(BigDecimal salary) {
        if(salary == null || getJobId()== null) {
            return true;
        }
        
        RowSet accessor = getJobsAccessor();
        if(accessor != null){
            JobsViewRowImpl currentRow = (JobsViewRowImpl)accessor.first();
            if(salary.intValue() < currentRow.getMinSalary() ||salary.intValue() > currentRow.getMaxSalary()){
                return false;
            }
        }
        return true;
    ...
    public static final int JOBSACCESSOR = AttributesEnum.JobsAccessor.index();
    ...
    /**
     * Gets the view accessor <code>RowSet</code> JobsAccessor.
     */
    public RowSet getJobsAccessor() {
        return (RowSet) getAttributeInternal(JOBSACCESSOR);
    }
